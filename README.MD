...
<details>
  ...
  <ol>
    ...
    <li>
        <a href="#">Yêu cầu</a>
        <ul>
          <li><a href="#">Hướng dẫn cài đặt VideoLibrary</a></li>
        </ul>
    </li>
    <li>
        <a href="#getting-started">Cách thực thi ứng dụng</a>
        <ul>
          <li><a href="#">Trực tiếp: (Sau khi tải về)</a></li>
          <li><a href="#">Gián tiếp: (GitHub)</a></li>
        </ul>
    </li>
    <li>
    ...
    <li>
        <a href="#">Thông tin người phát triển</a>
    </li>
  </ol>
</details>
<br>
